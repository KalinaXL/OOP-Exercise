    ...
    public static class DatabaseUtility
    {
        ...
        public static async void SaveInfoDatabase()
        {
            ...
            await Task.Run(new Action(() =>
            {
                ...
                sql.CreateTable<Profile>();
                sql.InsertAll(SaveInfo.profileList);
        ...
        public static async Task<bool> GetInfoDatabase()
        {
            ...
            await Task.Run(new Action(() =>
            {
                ...
                SaveInfo.profileList = sql.Table<Profile>().Select(item => item).ToList();
        ...
        {
            Profile stprofile = new Profile(LoginManager.profile[0], LoginManager.profile[1], LoginManager.profile[2], LoginManager.profile[3], LoginManager.profile[4]);
            SaveInfo.profileList.Add(stprofile);
        }

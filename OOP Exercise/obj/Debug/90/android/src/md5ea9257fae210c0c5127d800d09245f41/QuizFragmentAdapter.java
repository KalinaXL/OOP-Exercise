...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("OOP_Exercise.Adapters.QuizFragmentAdapter, OOP Exercise", QuizFragmentAdapter.class, __md_methods);
	}
	...
	public QuizFragmentAdapter (android.support.v4.app.FragmentManager p0)
	{
		...
		if (getClass () == QuizFragmentAdapter.class)
			mono.android.TypeManager.Activate ("OOP_Exercise.Adapters.QuizFragmentAdapter, OOP Exercise", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment", this, new java.lang.Object[] { p0 });
	}
